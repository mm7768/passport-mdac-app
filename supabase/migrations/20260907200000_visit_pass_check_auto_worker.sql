-- Migration: Add service-role RPC for automated Check Visit Pass completion and fallback.
-- Allows background Check Visit Pass Worker to write back SUCCEEDED (FOUND/NO_RECORD), FAILED (PIN_INVALID), or NEEDS_REVIEW.
...
begin
  ...
  -- Unlock batch if all items are done
