-- Migration: Add service-role RPC for automated Check Registration completion and fallback.
-- Allows background Check Registration Worker to write back SUCCEEDED, NEEDS_REVIEW, or FAILED.
